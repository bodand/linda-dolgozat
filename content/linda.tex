...
\begin{figure}[b!]
    \centering
    \resizebox{8.5cm}{!}{\includegraphics{figures/linda-in.pdf}}
...
\begin{figure}[thb]
    \centerline{\resizebox{8.5cm}{!}{\includegraphics{figures/linda-rd.pdf}}}
...
Ez egy elterjedt könyvtár a közös memóriával rendelkező párhuzamosításra, amit itt a szálakkal megvalósítok.
A szál--párhuzamosított részei a programnak azonban nagy részben  \aref{subsec:ranks}.~szekcióban tárgyalt thread--pool megvalósítás részeként üzemelnek, ami mellett egy--egy segéd szál végez még érdemi munkát.
...
Ezt a struktúrát könnyebnek véltem a beépített eszközökkel megvalósítani.
...
Utolsó előnye pedig, hogy egy ORDBMS ({\selectlanguage{english}Object-Relational Database Management System}), azaz objektum-relációs adatbázis kezelő rendszer: lehetővé teszi, hogy saját összetett típusokat lehessen definiálni, amelyeknek a tárolására alkalmas.
...
\begin{figure}[htb]
    \centerline{\resizebox{8cm}{!}{\includegraphics{figures/linda-arch.pdf}}}
...
Ezt a jelenlegi megvalósítás, az előzőekben már olvasható módon, a PostgreSQL adatbázist felhasználva valósítja meg.
...
Ezt a lehetőséget és hogy pár függvény felhasználásával lehetséges saját típust definiálni használja ki a Linda \ts{}, és a C \ac{ABI} elvárásainak megfelelő interfészen keresztül ad egy C++ megvalósítást a szükséges függvényekre.
...
Ami még érdekes az adatbázisból a Linda megvalósítás számára, az a keresés.
