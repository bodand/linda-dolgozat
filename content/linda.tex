...
\begin{figure}[b!]
    \centering
    \resizebox{10cm}{!}{\includegraphics{figures/linda-in.pdf}}
...
\begin{figure}[thb]
    \centerline{\resizebox{10cm}{!}{\includegraphics{figures/linda-rd.pdf}}}
...
\begin{figure}[htb]
    \centerline{\resizebox{9cm}{!}{\includegraphics{figures/query.pdf}}}
...
\begin{figure}[htb]
    \resizebox{\linewidth}{!}{\includegraphics{figures/linda-eval.pdf}}
...
Ezt megoldandó, egy saját megoldás bevezetésére mellett döntöttem: ez lett
...
\begin{figure}[htb]
    \centerline{\resizebox{9cm}{!}{\includegraphics{figures/linda-arch.pdf}}}
...
Összes feladata, ezzel szinkronban annyi, hogy a különböző processzek által küldött \nes{} objektumokat eltárolja, majd lehetővé tegye ezek között a keresést.
...
Ami még érdekes az adatbázisból a Linda megvalósítás számára, az a kereshetőség biztosítása.
...
\begin{table}[htb]
    \begin{tabularx}{\linewidth}{|l|l||c|X|}
        ...
        \texttt{ldb::lv::fn\_call} & függvényhívás & $5$ & A sztringben leírtak szerint kódoltan a függvény neve, majd a rekurzívan \nes{}ként kódolva a paraméterei \\\hline
