...
Erről ad \aref{fig:linda-arch}.~ábra áttekintést, amelyen 3 MPI processz közötti lehetséges kommunikációt szemléltet egy UML kommunikációs diagramot felhasználva.
...
A $0.$ processz egy speciális feladatot hajt végre, az szolgál a párhuzamos végrehajtás soros kezdőpontjaként.
...
Ezt a lehetőséget és hogy pár függvény felhasználásával lehetséges saját típust definiálni használja ki a Linda \ts{}, és C ABI--nak megfelelő interfészen keresztül ad egy C++ megvalósítást a szükséges függvényekre.
...
Ez minden esetben jelentősen több munka, mint egy egyszerű összehasonlító utasítás lefuttatása, nem is számolva a manuális SIMD kód kimagaslóan ,,jó'' karbantarthatóságával.
