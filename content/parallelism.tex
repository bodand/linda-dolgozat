...
Azóta, ahogy a futtatott szoftver is egyre jobban kihasználta a párhuzamosítás lehetőségeit, a magszám egyre fontosabbá vált a PC környezetben, annyira, hogy a modern felső kategóriás x86 asztali processzorok akár 16 fizikai maggal is rendelkeznek.
...
Az összes nyelvnek a célja az volt, hogy magas szintű programkódból tegyék lehetővé a algoritmusok megvalósítását párhuzamos transzpúter hardveren, kihasználva annak tényleges parallelizációs lehetőségeit, manuális transzpúter assembly írása nélkül.
Kiemelkedik közülük azonban az említett eredetileg a transzpúterekhez készített nyelv, az occam~(\textit{sic})~\cite{sgs-thomson_microelectronics_limited_occam_1995}.
